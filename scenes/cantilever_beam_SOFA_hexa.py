...
def createScene(root):
    ...
    root.addObject('SVKElasticForcefield_SOFA_Hexa', youngModulus="3000", poissonRatio="0.3", topology="@topology")
    ...
    # root.addObject('QuadSetGeometryAlgorithms')
    # root.addObject('QuadSetTopologyContainer', name='quad_container', quads='@top_roi.quadInROI')
    # root.addObject('QuadPressureForceField', pressure="0 -10 0", topology="@topology", quadList="@top_roi.quadIndices",
    #                showForces="1")
